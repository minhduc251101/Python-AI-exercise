...
T_gt = np.loadtxt('/media/minhduc/TOSHIBA EXT1/C++ hoc/Python-AI-exercise/results_27_5032/gt_transform.txt')
T_est = np.loadtxt('/media/minhduc/TOSHIBA EXT1/C++ hoc/Python-AI-exercise/results_27_5032/estimated_transform_final.txt')
