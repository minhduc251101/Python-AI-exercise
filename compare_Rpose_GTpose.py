...
T1_gt = np.eye(4)
T1_gt[:3, 3] = gt[0, 1:4]       # row 0 = pose1
T1_gt[:3, :3] = Rotation.from_quat(gt[0, 4:8]).as_matrix()

T2_gt = np.eye(4)
T2_gt[:3, 3] = gt[100, 1:4]     # row 100 = pose2
T2_gt[:3, :3] = Rotation.from_quat(gt[100, 4:8]).as_matrix()
